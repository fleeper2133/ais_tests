                        ...
                        <div class="creator__text">
                            ...
                            <div class="creator__data">
                                <div class="selector__data">
                                    <p class="white fs-14">Всего частых ошибок:</p>
                                    <p class="yellow fs-14 fw-bold">{{ aisStore.allMistakes.length }}</p>
                                </div>
                                <div v-if="aisStore.allMistakes.length >= 20" class="selector__data">
                                    <p class="white fs-14">Выбрано вопросов:</p>
                                    <p class="yellow fs-14 fw-bold">{{ questionCount }}</p>
                                </div>
                            </div>
                            <div v-if="aisStore.allMistakes.length >= 20" class="dropper">
                                ...
                                <div v-show="questions" class="dropper__list">
                                    ...
                                    <p v-if="aisStore.allMistakes.length >= 30" class="dropper__item" @click.stop="showedValue(30)">30 вопросов</p>
                                    <p v-if="aisStore.allMistakes.length >= 40" class="dropper__item" @click.stop="showedValue(40)">40 вопросов</p>
                                </div>
                            </div>
                        </div>
...
async function generateCheck() {
    ...
    const mistakesCount = aisStore.allMistakes.length
