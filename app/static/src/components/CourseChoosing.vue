        ...
        <div>
            ...
            <div class="content__gap">
                ...
                <div class="container container__courses">
                    ...
                    <div v-if="filterSearch.length > 0" class="courses">
                        <div v-for="(course, index) in filterSearch" class="course">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__info">
                                    <div class="info-text">
                                        <div class="info-text__stats">
                                            <p class="main-blue fw-bold">{{questionValue}}</p>
                                            <p class="main-blue">вопросов</p>
                                        </div>
                                        <div class="info-text__stats">
